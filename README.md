...
* **Templating Engine:** Thymeleaf (HTML5/CSS3)
* **Build Tool:** Maven
* **Dependency Management:** Spring Web, Spring Boot DevTools
...
* **Apache Maven:** Version 3.8+ (or use the included Maven wrapper `mvnw`)
...
```bash
git clone [https://github.com/Saicharanbanda/taskmanager.git](https://github.com/Saicharanbanda/taskmanager.git)
cd tasktracker
